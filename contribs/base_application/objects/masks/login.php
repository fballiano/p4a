...
class P4A_Login extends P4A_Mask
{
	function P4A_Login()
	{
		...
		// onReturnPress
		$user->addAction("onReturnPress");
		$pass->addAction("onReturnPress");
		$this->intercept($user, "onReturnPress", "enter");
		$this->intercept($pass, "onReturnPress", "enter");
