...
if (!defined('P4A_UPLOADS_DIR')) {
    if (P4A_OS == 'windows') {
        define('P4A_UPLOADS_DIR', P4A_Strip_Double_Backslashes(
            P4A_SERVER_DIR . str_replace('/', '\\', P4A_UPLOADS_PATH)
        ));
    } else {
...
if (!defined('P4A_THEME_FG')) {
    define('P4A_THEME_FG', '#4b718a');
}
if (!defined('P4A_THEME_BG')) {
    define('P4A_THEME_BG', '#fafafa');
}
if (!defined('P4A_THEME_BORDER')) {
    define('P4A_THEME_BORDER', '#ccc');
}

if (!defined('P4A_THEME_INPUT_FG')) {
    define('P4A_THEME_INPUT_FG', '#4b718a');
}
if (!defined('P4A_THEME_INPUT_BG')) {
    define('P4A_THEME_INPUT_BG', '#fff');
}
if (!defined('P4A_THEME_INPUT_BORDER')) {
    define('P4A_THEME_INPUT_BORDER', '#c6d3de');
}

if (!defined('P4A_THEME_SELECTED_FG')) {
    define('P4A_THEME_SELECTED_FG', '#000');
}
if (!defined('P4A_THEME_SELECTED_BG')) {
    define('P4A_THEME_SELECTED_BG', '#e2e7ed');
}
if (!defined('P4A_THEME_SELECTED_BORDER')) {
    define('P4A_THEME_SELECTED_BORDER', '#c6d3de');
}

if (!defined('P4A_THEME_TOOLTIP_FG')) {
    define('P4A_THEME_TOOLTIP_FG', '#777');
}
if (!defined('P4A_THEME_TOOLTIP_BG')) {
    define('P4A_THEME_TOOLTIP_BG', '#fff');
}
if (!defined('P4A_THEME_TOOLTIP_BORDER')) {
    define('P4A_THEME_TOOLTIP_BORDER', '#c6d3de');
}

if (!defined('P4A_THEME_EVEN_ROW')) {
    define('P4A_THEME_EVEN_ROW', '#f4f7fa');
}
if (!defined('P4A_THEME_ODD_ROW')) {
    define('P4A_THEME_ODD_ROW', '#e2e7ed');
}
...
if (!defined('P4A_FIELD_CLASS')) {
    define('P4A_FIELD_CLASS', 'P4A\Widget\Field');
}
...
if (!defined('P4A_EXCEPTION_HANDLER')) {
    define('P4A_EXCEPTION_HANDLER', 'P4A_Exception_Handler');
}
if (!defined('P4A_ERROR_HANDLER')) {
    define('P4A_ERROR_HANDLER', 'P4A_Error_Handler');
}
if (!defined('P4A_PASSWORD_OBFUSCATOR')) {
    define('P4A_PASSWORD_OBFUSCATOR', '**********');
}
if (!defined('P4A_DATEPICKER_START_YEAR')) {
    define('P4A_DATEPICKER_START_YEAR', date("Y") - 10);
}
if (!defined('P4A_DATEPICKER_END_YEAR')) {
    define('P4A_DATEPICKER_END_YEAR', date("Y") + 10);
}
if (!defined('P4A_DB_PROFILE')) {
    define('P4A_DB_PROFILE', false);
}
