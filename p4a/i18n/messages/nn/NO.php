...
(
	...
	// Standard Toolbar
	"save"				=> "Bekreft og lagre",
	"cancel"			=> "Avbryt gjeldende operasjon",
	"new"				=> "Legg inn en ny post",
	"delete"			=> "Slett gjeldende post",
	"print"				=> "Skriv ut",
	"exit"				=> "Avslutt",
	"first"				=> "Gå til det første elementet",
	"prev"				=> "Gå til det forrige elementet",
	"next"				=> "Gå til det neste elementet",
	"last"				=> "Gå til det siste elementet",
	"first_page"		=> "Gå til første side",
	"prev_page"			=> "Gå til forrige side",
	"next_page"			=> "Gå til neste side",
	"last_page"			=> "Gå til siste side",
	"go"				=> "Gå",
	...
	"filesize"			=> "Størrelse",
	"filetype"			=> "Type",
	"filepreview"		=> "Forhåndsvis",
	"filedelete"		=> "Slett",
	"filedownload"		=> "Last ned",
